        ...
        if ($this->getUser()->isInRole('admin'))
        {
            ...
            foreach ($kategorie as $kat)
            {
                ...
                foreach ($zbozi[$kat->id_kategorie] as $item)
                {
                    ...
                    $objPHPExcel->getActiveSheet()->SetCellValue('B' . $i, number_format($item->nakupni_cena,2, ',', ' ') . " Kč");
                    $objPHPExcel->getActiveSheet()->SetCellValue('C' . $i, number_format($item->prodejni_cena,2, ',', ' ') . " Kč" );
